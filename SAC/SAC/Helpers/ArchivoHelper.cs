...
namespace SAC.Helpers
{
    public class ArchivoHelper
    {
        ...
        public ArchivoHelper(String DeleteURL, String DeleteType, String StorageRoot, String UrlBase, String tempPath, String serverMapPath)
        {
        ...
        public String CheckThumb(String type, String FileName)
        {
            ...
            {
                realExt = FileName.Substring(FileName.LastIndexOf(".") + 1);
            }
            ...
            if (splited.Length == 2)
            {
                ...
                {
                    if (realExt.ToLower().Equals("xls"))
                    {
                        return "/Content/Free-file-icons/48px/xls.png";
                    }
                    if (realExt.ToLower().Equals("xlsx"))
                    {
                        return "/Content/Free-file-icons/48px/xlsx.png";
                    }
