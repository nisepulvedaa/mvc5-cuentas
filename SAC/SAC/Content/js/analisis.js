...
formEditar.Validador({
    nombreEditarArchivo: { required: [true, 'Debe Ingresar el Nombre  del archivo'] },
    montoEditarArchivo: { required: [true, 'Debe Ingresar un monto del archivo'], number: [true, 'El Monto del archivo debe ser un numero'] },
    comentarioEditarArchivo: { required: [true, 'Debe Ingresar un comentario '] }
});
                ...
                $.post('../EnviarAValidacion',
                    ...
                    function (rdata) {
                        if (rdata["response"] == "success") {
                            ...
                            swal({
                                title: "Enviar a Validacion",
                                text: "Cuenta Enviada a validación",
                                type: "success",
                                confirmButtonColor: "#DD6B55",
                                confirmButtonText: "Continuar",
                            }, function () {
